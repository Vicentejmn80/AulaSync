...
<head>
    ...
    <style>
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        .error-text { color:#be185d; font-size:1.1rem; margin-bottom:.5rem; }
        .hint-text { color:#6B4D87; font-size:.9rem; text-align:center; margin-top:1rem; }
    </style>
</head>
<body>
    ...
    <div class="glass-card">
        ...
        <h1 class="card-title">Acceso No Autorizado</h1>
        <p class="card-sub error-text">Tu cuenta todavía no tiene acceso a AulaSync. Contacta al administrador.</p>
        <p class="hint-text">El administrador deberá otorgarte permisos de super_admin para acceder a esta plataforma.</p>
    </div>
