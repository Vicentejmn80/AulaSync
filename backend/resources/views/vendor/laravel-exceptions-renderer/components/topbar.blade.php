...
>
    <div class="flex items-center gap-2 h-[56px] min-w-0">
        <div class="w-[18px] h-[18px] flex shrink-0 items-center justify-center bg-rose-500 rounded-md">
    ...
    <div class="flex items-center gap-2 shrink-0">
        <a
            href="{{ url('/') }}"
            class="text-sm rounded-md border px-3 h-8 inline-flex items-center gap-2 transition-colors duration-200 ease-in-out shadow-xs text-neutral-600 dark:text-neutral-300 bg-white/5 border-neutral-200 hover:bg-neutral-100 dark:bg-white/5 dark:border-white/10 dark:hover:bg-white/10 no-underline"
        >
        ...
        >
            ...
            <span x-show="!copied">Copiar como Markdown</span>
            <span x-show="copied" class="text-emerald-500">Copiado</span>
        </button>
    </div>
</div>
